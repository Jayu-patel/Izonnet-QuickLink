...
export default function AdminNavbar() {
    ...
    <div className='flex justify-between items-center px-4 sm:px-10 py-3 border-b bg-white'>
        ...
        <button onClick={()=>{setShowPopup(true)}} className='cursor-pointer bg-[#5f6fff] text-white text-sm px-5 md:px-10 py-2 rounded-full shadow-[1px_4px_12px_rgba(0,0,0,0.2)]'>Logout</button>
    </div> 
    )
}
